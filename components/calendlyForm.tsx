...
const CalendlyForm = ({ type }: { type?: string }) => {
    ...
    return (
        <>
            <div className="calendly-inline-widget" data-url={`https://calendly.com/${username}${type ? `/${type}` : ''}?hide_landing_page_details=${showDetails}&hide_gdpr_banner=${showCookies}`} style={{ minWidth: '320px', height: '330px' }}></div>
